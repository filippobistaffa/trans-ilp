...
static PyObject *__pyx_pf_6oracle_oracle(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_c, PyArrayObject *__pyx_v_reqs, PyArrayObject *__pyx_v_steps, PyArrayObject *__pyx_v_deltas, PyArrayObject *__pyx_v_distance, PyArrayObject *__pyx_v_time); /* proto */
...
static PyObject *__pyx_pw_6oracle_1oracle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_c,&__pyx_n_s_reqs,&__pyx_n_s_steps,&__pyx_n_s_deltas,&__pyx_n_s_distance,&__pyx_n_s_time,0};
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_c), __pyx_ptype_5numpy_ndarray, 1, "c", 0))) __PYX_ERR(0, 17, __pyx_L1_error)
  ...
  __pyx_r = __pyx_pf_6oracle_oracle(__pyx_self, __pyx_v_c, __pyx_v_reqs, __pyx_v_steps, __pyx_v_deltas, __pyx_v_distance, __pyx_v_time);
...
static PyObject *__pyx_pf_6oracle_oracle(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_c, PyArrayObject *__pyx_v_reqs, PyArrayObject *__pyx_v_steps, PyArrayObject *__pyx_v_deltas, PyArrayObject *__pyx_v_distance, PyArrayObject *__pyx_v_time) {
  ...
  __pyx_pybuffernd_time.rcbuffer = &__pyx_pybuffer_time;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_c.rcbuffer->pybuffer, (PyObject*)__pyx_v_c, &__Pyx_TypeInfo_unsigned_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_5 = 0;
  __pyx_t_6 = 0;
  __pyx_t_7 = PyFloat_FromDouble(cpp_oracle((__pyx_v_c->dimensions[0]), (&(*__Pyx_BufPtrCContig1d(unsigned int *, __pyx_pybuffernd_c.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_c.diminfo[0].strides))), (__pyx_v_reqs->dimensions[0]), (&(*__Pyx_BufPtrCContig1d(unsigned int *, __pyx_pybuffernd_reqs.rcbuffer->pybuffer.buf, __pyx_t_2, __pyx_pybuffernd_reqs.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(unsigned int *, __pyx_pybuffernd_steps.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_steps.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(unsigned int *, __pyx_pybuffernd_deltas.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_deltas.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(float *, __pyx_pybuffernd_distance.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_distance.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(float *, __pyx_pybuffernd_time.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_time.diminfo[0].strides))))); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 23, __pyx_L1_error)
 ...
 *            np.ndarray[unsigned int, ndim = 1, mode = "c"] steps,
 */
  __pyx_tuple__8 = PyTuple_Pack(6, __pyx_n_s_c, __pyx_n_s_reqs, __pyx_n_s_steps, __pyx_n_s_deltas, __pyx_n_s_distance, __pyx_n_s_time); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(6, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_oracle_pyx, __pyx_n_s_oracle, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
